...
def main(trackfilename: str = 'localhost-20181120_144618', *, frame_start: int = 1, frame_stop: int = 1500, frame_step: int = 1, batch_size: int = 100, save_interval: int = 100, start_over: bool = False):
    ...
    pose_path = f"{res_path}/{expID}/{expID}_testing.h5"
    ...
    batch_idx.append(frame_stop-frame_start-1)
...
def process_batch(network, frames, box_centers, box_angles, box_size):
    ...
    vplay(frames=boxes[fly_id == 0, ...], positions=positions[fly_id == 0, ...])
